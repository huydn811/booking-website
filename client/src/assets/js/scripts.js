...
$(() => {
  ...
  $('.notification-toggle').parent().on('shown.bs.dropdown', () => {
  ...
  $('.message-toggle').parent().on('shown.bs.dropdown', () => {
  ...
  $('[data-collapse]').each(function () {
    ...
    me.click(() => {
      ...
      $(target).on('shown.bs.collapse', (e) => {
        e.stopPropagation();
        me.html('<i className="fas fa-minus"></i>');
      });
      $(target).on('hidden.bs.collapse', (e) => {
        e.stopPropagation();
  ...
  $('[data-tab]').each(function () {
    ...
    me.click(() => {
      if (!me.hasClass('active')) {
        const tab_group = $(`[data-tab-group="${me.data('tab')}"]`);
        const tab_group_active = $(`[data-tab-group="${me.data('tab')}"].active`);
